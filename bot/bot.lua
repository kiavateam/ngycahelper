...
bot_token = "449326416:AAGJWZXTPvAPAV4-p7m9sleead-6_1XRnCk" --Put You Token Here
...
function create_config( )
	...
	if server_user:match("^root$") then
		BeyondTeam = '/root/ngyca'
	elseif not server_user:match("^root$") then
		BeyondTeam = '/home/'..server_user..'/ngyca'
	end
  ...
  config = {
    ...
    sudo_users = {247134702,291690408},--Sudo users
    admins = {},
    disabled_channels = {},
